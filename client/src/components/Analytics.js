...
//   const notify=() =>{
//     toast('Expense Surpassed Your Income!' ,{
//       position: 'top-right',
//       type: 'warning'
//     })
...
const categories =['salary' ,'entertainment' , 'freelance', 'travel', 'food', 'shopping','overtime', 'bonus', 'education' ,'medical' ,'tax' ]
  ...
  return (
    ...
    <Progress className='mx-3' strokeColor='#5DD64F' type='circle' percent={totalIncomeTransactionsPercentage.toFixed(0)}/>
...
<div  className='col-md-4 mt-2'>
    ...
    <div className='progress-bars'>
    <Progress className='mx-3' strokeColor='#5DD64F' type='circle' percent={totalIncomeTurnoverPercentage.toFixed(0)}/>
